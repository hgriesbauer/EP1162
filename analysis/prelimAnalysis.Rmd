...
pbai<- # assign output so we can plot several periods
  ...
  # Plotting function
pbai.Plot<-function(initYear,baPeriod,data=pbai) {
...
pbai.Plot(initYear="2009",baPeriod="2009-2019")
...
The relationship is consistent using initial BA for earlier periods (e.g., 1994):

```{r}
pbai.Plot(initYear="1994",baPeriod="2009-2019")
```
...
pbai.Plot(initYear="1994",baPeriod="2009-2019",data=pbai.2)
...
pbai.Plot(initYear="1994",baPeriod="1994-1997")
```
