...
x<-
 ...
 mono.x<- by(x$DBH,x$TreeID,monotonic)
...
```{r}
  ...
  dbhPred[dbhPred$TreeID==31 & dbhPred$Year==1994,"DBH"]=22.5
...
*The chunk below isn't set to run, because we only want to do this once*
