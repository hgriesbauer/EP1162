...
`r tablesNums("fitBA.table",caption="Summary of mixed effects model of tree-level basal area increment")`
...
`r tablesNums("fitBApct.table",caption="Summary of mixed effects model of tree-level basal area increment as percentage of initial tree size")`
