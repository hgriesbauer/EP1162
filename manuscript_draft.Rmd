...
In both species, post-treatment growth rates increased with the tree size at the time of treatment.  This has been found in other studies as well. and may be explained by the asymmetric competition theory whereby larger trees exert more competition on smaller trees. Implications of this result are that growth increases from treatment will be predominantly concentrated in the larger tree size classes.  If larger trees are able to increase their size faster than smaller trees and increase other metrics, such as crown size, to take advantage of increased growing space, then smaller trees will continue to experience competition and will not benefit as much from the thinning treatment.  Forest managers should account for potential size differential when planning thinning treatments.  For example, a silviculture treatment that seeks to release a suppressed understorey may have to ensure that sufficient overstorey trees are removed to reduce assymetric competition after treatment.    

## Stand-level responses to thinning treatments

Stand density 
The high-removal treatment unit increased stand density more than the control unit over the 27-year study period and the differences between control and treatment units decreased in each subsequent measurement period.  In 2019, there were no significant stand density differences between all units.  These results suggest that the thinned stands increased density faster than the control and within three decades, there are no significant differences between the three units.  We note that these estimates are for trees with a minimum diameter of 7.5cm at breast height, and therefore our data do not account for new seedlings that may have become established over the time period of the study.  Thus, the phenomenon of increasing stand density may simply indicate that small trees responded with faster diameter growth in the thinned treatments (as previously discussed) and were able to achieve the minimum diameter class in this study. Increasing densities in the smaller diameter classes also suggests that these stands will maintain a negative-exponential diameter distribution, which is considered typical of older, uneven-aged stands in this region.  Thus, thinning treatments may be used in this context to maintain a structure typical of uneven-aged stands. 


The low-removal thinning treatment also maintained a species composition similar to the control, in that subalpine fir was the leading species in the smaller diameter classes, and spruce was the leading species in the larger classes.  In closed forests with undisturbed forest floors, subalpine fir can have higher seedling establishment success than spruce, leading to higher densities of fir in the understorey.  Compared to spruce, subalpine fir can be relatively short-lived, however, and can die after 250 years in the canopy.  Spruce can live for over 400 years and thus can achieve larger sizes and dominant canopy positions.  This leads to a stand structure that is common in the Interior Region of BC and also found in the low-removal and control units.  The high-removal unit had a somewhat different species composition.  Here, fir was the leading species in all diameter classes.  This means that the high-removal thinning treatment converted the stand composition to fir-leading, which may be a primary concern for many forest managers, as spruce is often preferred as a crop species over subalpine fir [].  However, the stands in this treatment had more spruce in the smaller diameter classes than the other treatment units and spruce increased its composition compared to fir over the 27-year period of this study.  Over time, we expect that spruce would continue to increase its proportion relative to fir, resulting in similar species composition - diameter distributions as the other units. 


Volume and basal area
Our results showed that the low-removal treatment unit and the control unit were similar in terms of stand volume and basal area, and that increment in these variables did not differ much between the two.  Thus, the long-term implications of this is that these stands are on similar development trajectories
...
Stand mortality
Stand mortality increased with basal area after treatment.  This suggests that the thinning treatments may have captured some volume through trees that would have died naturally.  Thus, while volume removals from thinning are never entirely recoverable, this may not be true when mortality is considered.  
