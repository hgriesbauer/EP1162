...
periodInc.plot<-function(standVar,y.label){
  
  
  perInc.X %>%
  dplyr::select(BA.Target,Period,standVar,paste0(standVar,".se")) %>% 
    setNames(c("BA.Target","Period","Mean","SE")) %>% 
...
periodInc.plot("BA",y.label="BA (m²/ha)")
periodInc.plot("Vol",y.label="BA (m²/ha)")
