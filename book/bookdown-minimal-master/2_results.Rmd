...
standPlots<-cowplot::plot_grid(standVol.plot,standBA.plot,standK.plot,standQMD.plot,ncol=1,
                      align="v")
...
# Summarize models
library(lmerTest)
anova(fit.vol, type="3") 
  rbind(anova(fit.ba, type="3"))
anova(fit.sph, type="3")
...
Plot means of volume and basal area show that from 2009-2019, stand volume and basal area converged between both harvested treatment units, and were less than the control (
`r figNums("standPlots",display="cite")`).  The slope of all attributes showed that the low RBA accrued volume, density and diameter faster than the other units over the 27-year period of this study.  A linear model     
